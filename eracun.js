...
streznik.get('/', function(zahteva, odgovor) {
  if(zahteva.session.prijavljena_stranka == null){
    ...
    if (!pesmi) {
      ...
      vrniStranke(function(napaka1, stranke) {
        ...
        odgovor.render('eslog', {
          ...
          postavkeRacuna: pesmi,
          izbranaStranka: stranke[zahteva.session.prijavljena_stranka - 1]
        }) 
      })
    }
  })
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      ...
      stmt.finalize();
      sporocilo_uspesnost = "Stranka je bila uspešno registrirana."
...
streznik.post('/stranka', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    zahteva.session.prijavljena_stranka = polja.seznamStrank;
    odgovor.redirect('/')
  });
})
...
streznik.post('/odjava', function(zahteva, odgovor) {
    zahteva.session.prijavljena_stranka = null;
